...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let newVersion;
        if (customTag) {
            commits = yield utils_1.getCommits(latestTag.commit.sha, commitRef);
            ...
            if (commitMethod == 'tag') {
                commits = yield utils_1.getCommits(previousTag.commit.sha, commitRef);
            }
                ...
                commits = yield utils_1.getCommits(baseRef, commitRef);
            }
            else {
        ...
        yield github_2.createTag(newTag, createAnnotatedTag, commitRef);
    });
}
