...
exports.createTag = exports.fetchPRDetails = exports.compareCommits = exports.listTags = exports.getOctokitRESTSingleton = exports.getOctokitSingleton = void 0;
const github_1 = require("@actions/github");
const core = __importStar(require("@actions/core"));
let octokitSingleton;
let octokitRESTSingleton;
...
function getOctokitRESTSingleton() {
    if (octokitRESTSingleton) {
        return octokitRESTSingleton;
    }
    const githubToken = core.getInput('github_token');
    octokitRESTSingleton = github_1.getOctokit(githubToken);
    return octokitSingleton;
}
exports.getOctokitRESTSingleton = getOctokitRESTSingleton;
/**
...
function fetchPRDetails() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ('pull_request' in github_1.context.payload) {
            core.debug(`Get PR Details`);
            const pull_request = yield octokit.rest.pulls.get(Object.assign(Object.assign({}, github_1.context.repo), { pull_number: (_a = github_1.context.payload.pull_request) === null || _a === void 0 ? void 0 : _a.number }));
            const pull_merged = yield octokit.rest.pulls.checkIfMerged(Object.assign(Object.assign({}, github_1.context.repo), { pull_number: (_b = github_1.context.payload.pull_request) === null || _b === void 0 ? void 0 : _b.number }));
            return {
