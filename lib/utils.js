...
function getClosedPRCommits() {
    ...
    if ('pull_request' in github_2.context.payload && ((_a = github_2.context.payload.pull_request) === null || _a === void 0 ? void 0 : _a.base_ref)) {
        let pr_commit_count = JSON.parse((_b = github_2.context.payload) === null || _b === void 0 ? void 0 : _b.commits).length;
        core.info("We found " + pr_commit_count + " commits from the PR.");
        if (pr_commit_count) {
            commits = JSON.parse((_c = github_2.context.payload) === null || _c === void 0 ? void 0 : _c.commits)
