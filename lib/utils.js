...
function getCommits(baseRef, headRef) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core.info("We found " + (commits === null || commits === void 0 ? void 0 : commits.length) || 'unknown' + " commits after PRCommits");
...
function getClosedPRCommits() {
    var _a, _b, _c, _d, _e;
    let commits;
    core.info(JSON.stringify(github_2.context.payload.pull_request));
    if ('pull_request' in github_2.context.payload && ((_a = github_2.context.payload.pull_request) === null || _a === void 0 ? void 0 : _a.base_ref)) {
        let pr_commit_count = JSON.parse((_c = (_b = github_2.context.payload) === null || _b === void 0 ? void 0 : _b.pull_request) === null || _c === void 0 ? void 0 : _c.commits).length;
        core.info("We found " + pr_commit_count + " commits from the PR.");
        if (pr_commit_count) {
            commits = JSON.parse((_e = (_d = github_2.context.payload) === null || _d === void 0 ? void 0 : _d.pull_request) === null || _e === void 0 ? void 0 : _e.commits)
